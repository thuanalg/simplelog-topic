...
- **Support text, topics, binary log:**  
  With one text log is mandatory, multi-text topic, multi-binary topic; then it helps you have many choices.
